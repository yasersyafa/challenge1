...
<body>
    ...
    <div class="px-36 py-10" >
        <a href="insertcategory.php">
            ...
            <i class='bx bx-duplicate bx-md' ></i>
                <p class="font-bold text-xl" > Add Category +</p>
            </div>
        </a>
        <table class="mt-40 mx-auto border-2 border-white w-1/2" cellpadding="10" >
            ...
            <tr class="text-center" >
                ...
                <td class="border border-r border-black" ><a href="editcategory.php?id=<?= $rows['id_kategori']; ?>" class="text-yellow-500" ><i class='bx bxs-credit-card-alt bx-md'></i></a></td>
                <td class="border border-r border-black" ><a onClick="javascript:return confirm('Are you sure want to delete this?');" href='deletecategory.php?id=<?=$rows['id_kategori']?>' class="text-red-600" ><i class='bx bxs-trash bx-md' ></i></a></td>
            </tr>
            <?php } ?>
        </table>
    </div>
